...
import { deleteTransport } from "@/app/transports/actions";
...
export function DeleteTransportButton({ transportId, routeLabel }: Props) {
    ...
    <>
      ...
      {open ? (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="delete-transport-title"
          onClick={(e) => {
        ...
        >
          ...
          >
            <h2 id="delete-transport-title" className="text-lg font-bold text-slate-900">
              למחוק את ההסעה?
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              פעולה זו תמחק לצמיתות את ההסעה <span className="font-semibold">{routeLabel}</span>. לא ניתן לשחזר לאחר המחיקה.
            </p>
