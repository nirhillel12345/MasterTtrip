...
export type HomeHeroVariant = "landing" | "app";

export function HomeHero({ variant = "landing" }: { variant?: HomeHeroVariant }) {
          ...
          <div className="rounded-2xl border border-white/20 bg-white/[0.97] p-4 text-slate-900 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.35)] ring-1 ring-white/40 backdrop-blur-md sm:p-5 md:p-6">
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:gap-3 xl:gap-4">
              {mode === "listings" ? (
                ...
                <div className="grid w-full min-w-0 grid-cols-1 gap-3 md:grid-cols-4 md:items-end md:gap-3 md:flex-1">
                  ...
                  <label className="block w-full min-w-0 text-right">
                    ...
                    <input
                      ...
                      className="box-border block min-h-[44px] w-full max-w-full appearance-none rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm outline-none transition focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 sm:py-3"
                      dir="ltr"
                    />
                  </label>
                  <label className="block w-full min-w-0 text-right">
