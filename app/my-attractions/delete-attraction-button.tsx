...
import { deleteAttraction } from "@/app/attractions/actions";
...
export function DeleteAttractionButton({ attractionId, attractionLabel }: Props) {
    ...
    <>
      ...
      {open ? (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="delete-attraction-title"
          onClick={(e) => {
        ...
        >
          ...
          >
            <h2 id="delete-attraction-title" className="text-lg font-bold text-slate-900">
              למחוק את האטרקציה?
            </h2>
            <p className="mt-2 text-sm leading-relaxed text-slate-600">
              פעולה זו תמחק לצמיתות את <span className="font-semibold">{attractionLabel}</span>. לא ניתן לשחזר לאחר המחיקה.
            </p>
